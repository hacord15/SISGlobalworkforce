          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid lg:grid-cols-[1fr_460px] gap-10 items-start">
              ...
              >
                ...
                <div className="px-8 pt-8 pb-6 border-b border-brand-grey-100">
                  ...
                  <p className="text-sm text-brand-grey-500">
                    Fill out the form below and we&apos;ll get back to you within <strong className="text-brand-grey-700">4 working hours</strong>.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-5">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          >
                            <div className="pt-3 border-t border-brand-grey-100 mt-2 space-y-2">
                              <a href={`tel:${office.phone.replace(/\s/g,"")}`} className="flex items-center gap-2 text-xs text-brand-grey-600 hover:text-brand-red transition-colors">
                                <Phone size={12} className="text-brand-red flex-shrink-0" />
                                {office.phone}
                              </a>
                              <a href={`mailto:${office.email}`} className="flex items-center gap-2 text-xs text-brand-grey-600 hover:text-brand-red transition-colors">
                ...
                {/* Map embed for active office */}
                <div className="rounded-2xl overflow-hidden border border-brand-grey-200 shadow-sm" style={{ height: 220 }}>
                  <iframe
...
function InputField({
  ...
  return (
    <div>
      <label className="block text-xs font-bold text-brand-grey-700 uppercase tracking-widest mb-2">{label}</label>
      <input
        type={type}
        name={name}
