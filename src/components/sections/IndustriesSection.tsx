  ...
  return (
    <section className="py-20 grey-gradient-section" ref={ref}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <p className="text-brand-red text-sm font-semibold tracking-widest uppercase mb-2">What We Cover</p>
          <h2
          ...
          {industries.map((industry, i) => (
            ...
            >
              ...
              <div className="relative h-44 overflow-hidden">
                ...
                {/* Icon badge */}
                <div className="absolute top-3 left-3 w-10 h-10 bg-white rounded-full flex items-center justify-center text-lg shadow-md">
                  {industry.icon}
                </div>
              </div>
