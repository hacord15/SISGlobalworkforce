    ...
    <section className="py-20 bg-white" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-14">
          <p className="text-brand-red text-sm font-semibold tracking-widest uppercase mb-2">Our Advantages</p>
          <h2
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {whyCards.map((card, i) => (
            <div
              key={card.id}
              data-idx={i}
              className={`shuffle-card bg-white border border-brand-grey-200 rounded-xl p-7 ${
            ...
            >
              {/* Icon circle */}
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-brand-grey-100 to-brand-grey-200 flex items-center justify-center text-2xl mb-5 shadow-sm">
                {card.icon}
              </div>
